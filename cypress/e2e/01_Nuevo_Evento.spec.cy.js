describe('Carga de Evento', () => {
  ...
  it('Carga de evento completo', () => {
    ...
    // Validar pantalla Cargar Función
    ...
    cy.get('#react-aria-description-1').should('contain.text', '23 de septiembre de 2025');
   ...
   // --- CHECKBOX PREVENTA ---
    ...
    // --- ENTRADAS ---
// Click en el trigger para abrir el dropdown
      cy.get('button[data-slot="trigger"]').first().click({ force: true });

      // Click en la opción deseada directamente
